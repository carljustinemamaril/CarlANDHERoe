...
namespace ClassmatesRPGSimulator
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cbCharacter1.Items.Add("Carl_Fighter");
            
            cbCharacter1.Items.Add("Pons_Assassin");

            cbCharacter2.Items.Add("Carl_Fighter");
            
            cbCharacter2.Items.Add("Pons_Assassin");
        ...
        private Character CreateCharacter(string characterType, string playerName)
        {
            ...
            {
                case "Carl_Fighter":
                    return new Carl_Fighter(playerName);
                case "aa_Marksman":
                    
                case "Pons_Assassin":
                    return new Pons_Assassin(playerName);
                default:
